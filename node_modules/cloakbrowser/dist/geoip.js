...
import { ensureProxyScheme, isSocksProxy, reconstructSocksUrl } from "./proxy.js";
            ...
            try {
                const ip = await new Promise((resolve, reject) => {
                    ...
                    connectReq.on("connect", (_res, socket) => {
                        ...
                        const req = https.request(echoUrl, { socket, timeout: Math.min(5_000, innerRemaining ?? 5_000) }, (res) => {
                            let data = "";
                            res.on("data", (chunk) => (data += chunk.toString()));
                            res.on("end", () => {
                                const ip = data.trim();
