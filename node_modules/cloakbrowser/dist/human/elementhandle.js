...
export function patchSingleElementHandle(el, page, cfg, cursor, raw, rawKb, originals, stealth) {
    ...
    const moveToElement = async (callCfg = cfg) => {
        ...
        try {
            const { cursorX, cursorY } = await humanScrollIntoView(page, raw, () => el.boundingBox(), cursor.x, cursor.y, callCfg);
            cursor.x = cursorX;
            cursor.y = cursorY;
        }
