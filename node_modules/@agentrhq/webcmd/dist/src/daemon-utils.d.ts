...
export declare const PROFILE_DISCONNECTED_HINT = "Open that Chrome profile and make sure the Webcmd extension is enabled, or choose another profile with webcmd profile use <name>.";
