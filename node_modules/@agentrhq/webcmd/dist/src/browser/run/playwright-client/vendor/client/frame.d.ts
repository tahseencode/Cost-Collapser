...
export declare class Frame extends ChannelOwner<channels.FrameChannel> implements api.Frame {
    ...
    _drop(selector: string, payload: DropPayload, options?: Omit<channels.FrameDropOptions, 'payloads' | 'localPaths' | 'streams' | 'data'> & TimeoutOptions): Promise<void>;
    ...
    _highlight(selector: string, style?: string): Promise<any>;
    _hideHighlight(selector: string): Promise<any>;
    ...
    _expect(expression: string, options: Omit<channels.FrameExpectParams, 'expression'>): Promise<ExpectResult>;
}
