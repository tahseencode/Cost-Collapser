...
export declare function formatObject(value: any, indent?: string, mode?: 'multiline' | 'oneline'): string;
export declare function formatObjectOrVoid(value: any, indent?: string): string;
...
export declare function parseRegex(regex: string): RegExp;
export declare function tomlBasicString(value: string): string;
export declare function tomlArray(values: string[]): string;
