...
export declare function splitTestIdAttributeNames(testIdAttributeName: string): string[];
export declare function encodeTestIdAttributeName(testIdAttributeName: string): string;
