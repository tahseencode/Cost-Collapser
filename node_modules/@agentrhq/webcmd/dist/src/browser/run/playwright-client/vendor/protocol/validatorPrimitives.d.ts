...
export declare function findValidator(type: string, method: string, kind: 'Initializer' | 'Event' | 'Params' | 'Result' | 'ErrorDetails'): Validator;
export declare function maybeFindValidator(type: string, method: string, kind: 'Initializer' | 'Event' | 'Params' | 'Result' | 'ErrorDetails'): Validator | undefined;
export declare function createMetadataValidator(): Validator;
export declare function createWaitInfoValidator(): Validator;
