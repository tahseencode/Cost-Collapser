...
export function locatorOrSelectorAsSelector(language, locator, testIdAttributeName = 'data-testid') {
    try {
...
export function unsafeLocatorOrSelectorAsSelector(language, locator, testIdAttributeName = 'data-testid') {
    try {
