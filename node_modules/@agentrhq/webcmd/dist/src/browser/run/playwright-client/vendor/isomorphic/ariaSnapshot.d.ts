...
export declare function ariaNodesEqual(a: AriaNode, b: AriaNode): boolean;
export declare function hasPointerCursor(ariaNode: AriaNode): boolean;
...
export declare function findNewNode(from: AriaNode | undefined, to: AriaNode): AriaNode | undefined;
export {};
