...
export const isURLPattern = (v) => typeof globalThis.URLPattern === 'function' && v instanceof globalThis.URLPattern;
export function serializeURLPattern(v) {
    return {
        hash: v.hash,
        hostname: v.hostname,
        password: v.password,
...
export function serializeURLMatch(match) {
    if (isString(match))
        return { glob: match };
    if (isRegExp(match))
