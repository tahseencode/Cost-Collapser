...
export declare class Locator implements api.Locator {
    ...
    dispatchEvent(type: string, eventInit?: Object, options?: TimeoutOptions): Promise<any>;
    dragTo(target: Locator, options?: channels.FrameDragAndDropOptions & TimeoutOptions): Promise<any>;
    drop(payload: DropPayload, options?: Omit<channels.FrameDropOptions, 'payloads' | 'localPaths' | 'streams' | 'data' | 'force' | 'trial'> & TimeoutOptions): Promise<void>;
    ...
    ariaSnapshot(options?: TimeoutOptions & {
        mode?: 'ai' | 'default';
        depth?: number;
        boxes?: boolean;
    }): Promise<string>;
    scrollIntoViewIfNeeded(options?: channels.ElementHandleScrollIntoViewIfNeededOptions & TimeoutOptions): Promise<unknown>;
    ...
    setInputFiles(files: string | FilePayload | string[] | FilePayload[], options?: channels.ElementHandleSetInputFilesOptions & TimeoutOptions): Promise<any>;
