...
Prefer green evidence. If you proceed on yellow evidence, record the uncertainty with `webcmd site note add <site> --text <markdown>` after the run so the next agent starts with better context.
